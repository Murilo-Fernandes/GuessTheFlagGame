...
public class TelaQuiz8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_quiz8);
        ...
        btnAnswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(radioButton.getId() == R.id.rbRight) {
                    acertos++;
                    Toast.makeText(TelaQuiz8.this, "Resposta correta!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(TelaQuiz8.this, "Resposta errada!", Toast.LENGTH_SHORT).show();
                }
                // Passa para a próxima tela (ou finaliza o quiz)
                Intent it = new Intent(TelaQuiz8.this, TelaQuiz9.class);
