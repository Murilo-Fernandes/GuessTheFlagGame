...
public class TelaQuiz10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_quiz10);
        ...
        btnAnswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(radioButton.getId() == R.id.rbRight) {
                    acertos++;
                    Toast.makeText(TelaQuiz10.this, "Resposta correta!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(TelaQuiz10.this, "Resposta errada!", Toast.LENGTH_SHORT).show();
                }
                // Passa para a próxima tela (ou finaliza o quiz)
                Intent it = new Intent(TelaQuiz10.this, TelaFinal.class);
