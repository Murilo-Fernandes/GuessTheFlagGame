        ...
        btnAnswer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(radioButton.getId() == R.id.rbRight) {
                    acertos++;
                    Toast.makeText(TelaQuiz3.this, "Resposta correta!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(TelaQuiz3.this, "Resposta errada!", Toast.LENGTH_SHORT).show();
                }
                // Passa para a próxima tela (ou finaliza o quiz)
                Intent it = new Intent(TelaQuiz3.this, TelaQuiz4.class);
